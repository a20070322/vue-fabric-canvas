...
export default {
  ...
  methods: {
    ...
    drawTypeChange(e) {
      ...
      if (e !== "text" && this?.textbox?.isEditing) {
    ...
    mousedown(e) {
      ...
      if (this.textbox && this.drawType == "text") {
      ...
      switch (this.drawType) {
        ...
        case "pentagram": //五角星
          var x11 = mouseFrom.x,
            ...
            y22 = mouseTo.y;
          /**
           * 实现思路  (x11,y11)表示鼠标起始的位置 (x22,y22)表示鼠标抬起的位置
           * r 表示五边形外圈圆的半径，这里建议自己画个图理解
           * 正五边形夹角为36度。计算出cos18°，sin18°备用
           */
          var w_2 = Math.abs(x22 - x11),
            h_2 = Math.abs(y22 - y11),
            r = Math.sqrt(w_2 * w_2 + h_2 * h_2);
           ...
           * 算出对应五个点的坐标转化为路径
           */
          var point1 = [x11, y11 + r];
          var point2 = [x11 + 2 * r * sin18, y11 + r - 2 * r * cos18];
          var point3 = [x11 - r * cos18, y11 + r * sin18];
          var point4 = [x11 + r * cos18, y11 + r * sin18];
          var point5 = [x11 - 2 * r * sin18, y11 + r - 2 * r * cos18];

          var path_2 = " M " + point1[0] + " " + point1[1];
          path_2 += " L " + point2[0] + " " + point2[1];
          path_2 += " L " + point3[0] + " " + point3[1];
          path_2 += " L " + point4[0] + " " + point4[1];
          path_2 += " L " + point5[0] + " " + point5[1];
          path_2 += " Z";
          canvasObject = new fabric.Path(path_2, {
            stroke: this.color,
            fill: this.color,
            strokeWidth: this.drawWidth,
            // angle:180,  //设置旋转角度
        ...
        case "rectangle": //长方形
          ...
          var path_1 =
            ...
            mouseFrom.y +
            " z";
          canvasObject = new fabric.Path(path_1, {
            left: left,
            top: top,
            stroke: this.color,
            strokeWidth: this.drawWidth,
